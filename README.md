...
Technical Workflow
Data Preprocessing: Handled missing values, performed One-Hot Encoding for categorical variables, and applied Feature Scaling to normalize numerical data.

EDA (Exploratory Data Analysis): Identified key drivers for conversion, such as call duration and previous contact frequency.

Model Building: Implemented and compared three classification algorithms:
...
Evaluation: Used Accuracy, Precision, Recall, and F1-Score to determine the best-performing model.
